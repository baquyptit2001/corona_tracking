...
<!-- Mirrored from demos.codexcoder.com/labartisan/html/covid-19/one-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 24 Jun 2021 14:20:05 GMT -->
<head>
		<meta charset="UTF-8">
	...
	<body>
        ...
        <section class="banner-section home-3" id="app">
            <div class="banner-area">
                <div class="container">
                    <div class="row align-items-center justify-content-center">
                        <div class="col-md-6 col-12">
                            <div class="content-part" id="app">
                                <app></app>
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
			...
			<div class="header-area">
				<div class="container">
					<div class="primary-menu">
						<div class="logo">
							<a href="{{ route('home') }}"><img src="assets/images/logo/03.png" alt="logo"></a>
                        </div>
						<div class="main-area">
							<div class="main-menu">
								<ul class="lab-ul">
...
<!-- Mirrored from demos.codexcoder.com/labartisan/html/covid-19/one-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 24 Jun 2021 14:21:28 GMT -->
</html>